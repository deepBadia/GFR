"""Train the baseline GFR-Net (full pool, no active learning) on secteur1.h5.
...
if __name__ == "__main__":
    ...
    if not args.skip_report:
        config = load_config("secteur1_gfr", config_file=str(HERE / "config.yaml"))
