"""Train Active-GFR-Net with a pool-based active-learning loop on absorbant.h5.
...
is to answer "how few of the absorbant geometries do we actually need?").
...
if __name__ == "__main__":
    ...
    parser.add_argument("--patience-per-round", type=int, default=60)
    parser.add_argument("--seed-frac", type=float, default=0.05)
    parser.add_argument("--query-frac", type=float, default=0.05)
    args = parser.parse_args()

    result = run_active_learning(
        experiment="absorbant_active_gfr",
