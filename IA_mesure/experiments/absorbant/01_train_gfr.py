"""Train the baseline GFR-Net (full pool, no active learning) on absorbant.h5.
...
if __name__ == "__main__":
    ...
    if not args.skip_report:
        config = load_config("absorbant_gfr", config_file=str(HERE / "config.yaml"))
