"""Train the baseline GFR-Net (full pool, no active learning) on secteur1_amp_phase.h5.
...
if __name__ == "__main__":
    ...
    best_val_loss = train_model(
        experiment="secteur1_amp_phase_gfr",
    ...
    if not args.skip_report:
        config = load_config("secteur1_amp_phase_gfr", config_file=str(HERE / "config.yaml"))
