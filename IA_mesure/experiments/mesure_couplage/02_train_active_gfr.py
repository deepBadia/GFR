"""Train Active-GFR-Net with a pool-based active-learning loop on mesure_couplage.h5.
...
is to answer "how few of the mesure_couplage geometries do we actually need?").
...
if __name__ == "__main__":
    ...
    parser.add_argument("--epochs-per-round", type=int, default=300)
    parser.add_argument("--patience-per-round", type=int, default=300)
    parser.add_argument("--seed-frac", type=float, default=0.3)
    parser.add_argument("--query-frac", type=float, default=0.2)
    args = parser.parse_args()

    result = run_active_learning(
        experiment="mesure_couplage_active_gfr",
